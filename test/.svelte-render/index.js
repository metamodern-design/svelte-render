...
/* test/fixtures/components/Message.svelte generated by Svelte v3.20.1 */
...
const Message = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	$$result.css.add(css);
	return `<span class="${"svelte-1l1lbdl"}">Have a ${escape(adjective)} day! </span>`;
});
...
/* test/fixtures/components/Clock.svelte generated by Svelte v3.20.1 */
...
const Clock = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	let time = format(now);
	return `<p class="${"svelte-xvgr68"}">The time is now ${escape(time)}. </p>`;
});

/* test/fixtures/index.svelte generated by Svelte v3.20.1 */
